...
![Image](./3.2.1-Dom_ClassDiagram_edit.png)
...
###### Επικοινωνία με υπάλληλο της γραμματείας:
...
![Image](./3.2.2_UseCaseDiagram_edit.png)
...
###### Με την αφαίρεση ενός κατασκευαστή που χρησιμοποιείται από άλλη περίπτωση χρήσης:

...
import gr.aueb.softeng.project1809.services.ECustomBilling;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        share.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String myRecSum = "<B>ESCAPE ROOMS RESERVATION</B><br>";
                ...
                EmailMessage message = new EmailMessage("New Escape Room Reservations!", myRecSum);
                sendEmail(message);
            }
        });
    }
